...
fname = f"techno_pair1_edge2_{tr['type']}.flac"
...
row = {
    ...
    "B_first_4_bars_db": [db(end + k * bar, end + (k + 1) * bar) for k in range(4)],
...
logging.info("DONE %s", json.dumps(row))
logging.info("WORST DONE")
